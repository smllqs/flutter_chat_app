...
// in flutter_chat_app/test/viewmodels/chats_view_model_test.dart.
...
import 'package:flutter_chat_app/data/data_source/data_source_contract.dart'
    as _i2;
import 'package:flutter_chat_app/models/chat.dart' as _i4;
...
class MockIDataSource extends _i1.Mock implements _i2.IDataSource {
  ...
  @override
  _i3.Future<void> deteleChat(String? chatId) => (super.noSuchMethod(
        Invocation.method(
          #deteleChat,
          [chatId],
        ),
